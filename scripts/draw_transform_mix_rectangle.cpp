...
int main() {
  ...
  VertexShader v = load_vertex_shader("shaders/transform_color_tex.vert");
  ...
  Affine3f transform;
  // Transform elements are initialized to nan
  transform = AngleAxisf(0.5*M_PI, Vector3f::UnitZ());
  transform.scale(Vector3f(0.5, 0.5, 0.5));
  ...
  program.set_uniform("transform", transform.matrix());
